$(document).ready(function () {
    ...
    $('#taffe thead tr')
        .clone(true)
        .addClass('filters')
        .appendTo('#taffe thead');
 
    var table = $('#taffe').DataTable({
        dom: 'Bfrtip',
        stateSave: true,
        buttons: [
